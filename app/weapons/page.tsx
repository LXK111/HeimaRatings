  ...
  return (
    ...
    >
      <Panel eyebrow="Create" title="新增武器类型">
        <form action={createWeaponAction} className="grid gap-4 md:grid-cols-[1.2fr_1fr_auto_auto]">
        ...
        <DataTable
          ...
          rows={weaponTypes.map((weapon) => [
            ...
            <form
              ...
              className="grid min-w-[430px] grid-cols-[1fr_1fr_72px_auto] items-end gap-3"
              key="edit"
            >
